...
@section('title')
    Edit '{!! strtolower($personal_info->name) !!}' Personal Information
@stop
@section('content')
    <div class="card shadow p-2">
        {!! Form::open(['route' => '/admin_panel/members/personal_info/edit/action', 'method' => 'post']) !!}
        <div class="row p-lg-4 p-md-2">
            <input type="number" name="user_id" value="{{ $personal_info->user_id }}" hidden>
            <div class="col-lg-6">
            ...
            <div class="pt-4 pl-2 border-top w-100">
                <a href="{{ route('/admin_panel/members/details/',['user_id'=>$personal_info->user_id]) }}" class="btn btn-dark mb-2">back</a>
