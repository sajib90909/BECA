...
@section('content')
    <div class="card shadow p-2">
        {!! Form::open(['route' => '/admin_panel/members/edu_pro_details/edit/action', 'method' => 'post']) !!}
        <div class="row p-lg-4 p-md-2">
            <input type="number" name="user_id" value="{{ $edu_pro_details->user_id }}" hidden>
            <div class="col-lg-6">
            ...
            <div class="pt-4 pl-2 border-top w-100">
                <a href="{{ route('/admin_panel/members/details/',['user_id'=>$edu_pro_details->user_id]) }}" class="btn btn-dark mb-2">back</a>
